namespace GUI.DashboardApp
{
    partial class ucQuanLySoTietKiem
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnThemPhieu = new Guna.UI2.WinForms.Guna2GradientButton();
            ...
            guna2Panel2.Controls.Add(btnThemPhieu);
            ...
            lblLoaiTietKiem0.Location = new Point(536, 11);
            ...
            lblTenKhachHang0.Location = new Point(94, 11);
            ...
            // btnThemPhieu
            // 
            btnThemPhieu.Anchor = AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            btnThemPhieu.BorderRadius = 10;
            btnThemPhieu.CustomizableEdges = customizableEdges15;
            btnThemPhieu.DisabledState.BorderColor = Color.DarkGray;
            btnThemPhieu.DisabledState.CustomBorderColor = Color.DarkGray;
            btnThemPhieu.DisabledState.FillColor = Color.FromArgb(169, 169, 169);
            btnThemPhieu.DisabledState.FillColor2 = Color.FromArgb(169, 169, 169);
            btnThemPhieu.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            btnThemPhieu.FillColor = Color.AliceBlue;
            btnThemPhieu.FillColor2 = Color.AliceBlue;
            btnThemPhieu.Font = new Font("Segoe UI Semibold", 11F, FontStyle.Bold);
            btnThemPhieu.ForeColor = Color.FromArgb(39, 20, 85);
            btnThemPhieu.Image = (Image)resources.GetObject("btnThemPhieu.Image");
            btnThemPhieu.ImageOffset = new Point(40, 0);
            btnThemPhieu.ImageSize = new Size(30, 30);
            btnThemPhieu.Location = new Point(28, 540);
            btnThemPhieu.Name = "btnThemPhieu";
            btnThemPhieu.ShadowDecoration.CustomizableEdges = customizableEdges16;
            btnThemPhieu.Size = new Size(868, 43);
            btnThemPhieu.TabIndex = 17;
            btnThemPhieu.Text = "Thêm mới";
        ...
        private Guna.UI2.WinForms.Guna2GradientButton btnThemPhieu;
